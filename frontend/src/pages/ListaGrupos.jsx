...
import { ArrowLeft, Users, Plus, Search, Calendar, Layers, Hash } from "lucide-react"
...
function ListaGrupos() {
    ...
    useEffect(() => {
        ...
        if (stored && JSON.parse(stored).length > 0) {
            ...
            const mockGrupos = [
                { id: 1, codigo: "FE-001", nome: "React Ninjas", data: "2024-03-10", ano: "2024", periodo: "1º Semestre", mvp: "Frontend", alunos: [] },
                { id: 2, codigo: "FE-002", nome: "Vue Vanguards", data: "2024-03-15", ano: "2024", periodo: "1º Semestre", mvp: "Frontend", alunos: [] },
                { id: 3, codigo: "FE-003", nome: "Angular Architects", data: "2024-08-20", ano: "2024", periodo: "2º Semestre", mvp: "Frontend", alunos: [] },
                { id: 4, codigo: "FE-004", nome: "Svelte Squad", data: "2025-02-10", ano: "2025", periodo: "1º Trimestre", mvp: "Frontend", alunos: [] },
                { id: 5, codigo: "BE-001", nome: "Node Knights", data: "2024-04-05", ano: "2024", periodo: "1º Semestre", mvp: "Backend", alunos: [] },
                ...
                { id: 8, codigo: "BE-004", nome: "Go Gurus", data: "2025-03-15", ano: "2025", periodo: "1º Trimestre", mvp: "Backend", alunos: [] },
                { id: 9, codigo: "MB-001", nome: "Flutter Foxes", data: "2024-02-20", ano: "2024", periodo: "1º Semestre", mvp: "Mobile", alunos: [] },
                { id: 10, codigo: "MB-002", nome: "React Native Rangers", data: "2024-06-10", ano: "2024", periodo: "1º Semestre", mvp: "Mobile", alunos: [] },
    ...
    const gruposFiltrados = grupos.filter((g) => {
        ...
        return matchAno && matchPeriodo && matchData && matchBusca
    })
