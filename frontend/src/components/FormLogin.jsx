        ...
        <div className="flex flex-col items-center justify-center p-4 bg-[#006b64] max-w-80 rounded-md animate-slide-down">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4 ">
                ...
                <div className="flex items-center bg-white rounded-md overflow-hidden">
                    ...
                    <Input type="email" id="email" name="email" placeholder="Digite seu email" ref={emailRef} className="flex-1 px-3 py-2 outline-none text-sm" />
                </div>
                ...
                <Button type="submit" className="w-full mt-2 tracking-widest ">ACESSAR</Button>
            </form>
        </div>
    )
}
